...
<body>
        ...
        if(isset($_POST['submit'])){
            ...
            $update = " update users set takenbookname='$BookName',author='$Author',edition='$Eidition',takendate='$Date',returndate='$Return',fine='$Fine' where u_id= $idupdate";
    ...
    <div class = "box">
        ...
        <form action="" method="POST"> 
            ...
            <div class="next">
            <button><a href="inc/usersdisplay.php">View Record</a></button>
</div>
        </form> 
    </div>
