...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $update = " update supplier set bookname='$BookName',author='$Author',suppliername='$Suppliername',deliverydate='$Deliverydate',price='$Price',quantity='$Quantity' where b_id= $idupdate";
